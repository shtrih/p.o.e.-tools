#include-once
; #FUNCTION# ====================================================================================================================
; https://www.autoitscript.com/forum/topic/147681-_printfromarray-print-an-array-to-the-console/
...
; Example .......: Yes
; ===============================================================================================================================
Func _PrintArrayConsole(ByRef Const $aArray, $iBase = Default, $iUBound = Default, $sDelimeter = "|")
